...
using Forum.Infrastructure.StaticData;
...
namespace Forum.Infrastructure.Initializers
{
    ...
    /// </summary>
    public class ForumDbInitializer : IDbInitializer
    {
        private readonly ILogger<ForumDbInitializer> _logger;
        private readonly ForumDbContext _dbContext;
        private readonly UserManager<UserEntity> _userManager;
        private readonly RoleManager<RoleEntity> _roleManager;

        /// <summary>
        /// Initializes a new instance of the <see cref="ForumDbInitializer"/> class.
        /// </summary>
        ...
        public ForumDbInitializer(
            ForumDbContext dbContext,
            UserManager<UserEntity> userManager,
            RoleManager<RoleEntity> roleManager,
            ILogger<ForumDbInitializer> logger)
        {
        ...
        private async Task InitialIdentitiesAsync()
        {
            ...
            await CheckRoleAsync(UserStatus.Admin.ToString());
            await CheckRoleAsync(UserStatus.User.ToString());
            await CheckRoleAsync(UserStatus.Banned.ToString());
