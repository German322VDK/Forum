namespace Forum.Infrastructure.StaticData
{
    /// <summary>
    /// Contains initialization data constants used for setting up default user, trad, post, and comment data in the application.
    /// </summary>
    public class InitData
    {
        ...
        /// <summary>
        /// The path to the main trad's picture.
        /// </summary>
