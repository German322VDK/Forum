...
namespace Forum.Infrastructure.Tests.Services.Stores.Contents
{
    public class TradStoreTests
    {
        ...
        public TradStoreTests()
        {
            ...
            _options = new DbContextOptionsBuilder<ForumDbContext>()
        ...
        {
            using ForumDbContext context = new ForumDbContext(_options);
            context.Database.EnsureCreated();
            var userStore = new UserStore<UserEntity, RoleEntity, ForumDbContext, int>(context);
