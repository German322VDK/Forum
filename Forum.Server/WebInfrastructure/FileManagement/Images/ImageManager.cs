namespace Forum.Server.WebInfrastructure.FileManagement.Images
{
    /// <summary>
    ...
    public class ImageManager : IImageManager
    {
        ...
        private const string TRADS_DIRECTORY = "trads";
        private const string TRAD_PATH = "trad-";
        private const string POST_PATH = "-post-";
        private const string COMMENT_PATH = "-com-";
        ...
        {
            string tradImagePrefix = $"{TRAD_PATH}{tradId}";
            string tradsFolder = Path.Combine(_env.WebRootPath, UPLOADS_DIRECTORY, TRADS_DIRECTORY);
        ...
        {
            string postImagePrefix = $"{TRAD_PATH}{tradId}{POST_PATH}{postId}";
            string tradsFolder = Path.Combine(_env.WebRootPath, UPLOADS_DIRECTORY, TRADS_DIRECTORY);
        ...
        {
            string commentImagePrefix = $"{TRAD_PATH}{tradId}{POST_PATH}{postId}{COMMENT_PATH}{commentId}";
            string tradsFolder = Path.Combine(_env.WebRootPath, UPLOADS_DIRECTORY, TRADS_DIRECTORY);
        ...
        {
            string fileNamePrefix = $"{TRAD_PATH}{tradId}";
            return await SaveImageAsync(image, TRADS_DIRECTORY, fileNamePrefix);
        }
        ...
        {
            string fileNamePrefix = $"{TRAD_PATH}{tradId}{POST_PATH}{postId}";
            return await SaveImageAsync(image, TRADS_DIRECTORY, fileNamePrefix);
        }
        ...
        {
            string fileNamePrefix = $"{TRAD_PATH}{tradId}{POST_PATH}{postId}{COMMENT_PATH}{commentId}";
            return await SaveImageAsync(image, TRADS_DIRECTORY, fileNamePrefix);
        }
        ...
        {
            string existingFiles = Path.Combine(_env.WebRootPath, UPLOADS_DIRECTORY, USERS_DIRECTORY);
            DeleteExistingFiles(existingFiles, userName);

            return await SaveImageAsync(image, USERS_DIRECTORY, userName);
        }
